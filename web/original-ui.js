...
window.LiveUI = (() => {
  ...
  function healthOverview() {
    if(window.HermesDeviceData)return window.HermesDeviceData.overview();
  ...
  function extraPage() {
    if(state.page==='health')return window.HermesDeviceData.healthPanel();
    if(state.page==='calendar')return helpers.page()+window.HermesDeviceData.calendarPanel();
