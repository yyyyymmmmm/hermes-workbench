...
for(const [target,source]of Object.entries({'assets/marked-LICENSE.md':'node_modules/marked/LICENSE.md','assets/dompurify-LICENSE':'node_modules/dompurify/LICENSE','assets/dompurify-LICENSE-MPL':'node_modules/dompurify/LICENSE-MPL'}))assets.set(target,readFileSync(join(root,source)));
